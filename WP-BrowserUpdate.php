...
add_options_page('WP BrowserUpdate '.__('Settings'), 'WP BrowserUpdate', 'manage_options', 'wp-browserupdate', 'wpbu_administration');
}

function wpbu_settings_link($links, $file) {
$settings_link = '<a href="'.admin_url('options-general.php?page=wp-browserupdate').'">'.__('Settings').'</a>';
